...
* If you are Powered By Art Blocks (PBAB), see step 8 [here](https://docs.artblocks.io/creator-docs/powered-by-art-blocks-pbab-onboarding/pbab-101/adding-new-project-shells) for guidance.
...
* Your project’s outputs must be dimension agnostic, meaning it scales seamlessly to any window size. See more on this [here](https://docs.artblocks.io/creator-docs/creator-onboarding/readme#dimensionless). This field is used to set the aspect ratio for image renders, but does not have any impact on an output’s live view. * While you can control the aspect ratio, you will have no control over the dimensions of the browser someone else might be using.
...
* For many artists, the process for writing your features script will likely entail starting with your project script, copying it into the `calculateFeatures` interface/shell found [here](https://docs.artblocks.io/creator-docs/creator-onboarding/readme/features#features-script-interface), and then trimming it down to remove all library (e.g. p5js) references and draw functionality and instead to build the relative key-value object map for your features.
...
* To learn more about royalty distributions, see [here](https://docs.artblocks.io/creator-docs/creator-onboarding/readme/faqs#how-does-royalty-distribution-work). 
