...
[Agent Skills](/developer/mcp-server/skills/) teach your AI agent Art Blocks-specific workflows and best practices — which tool to use, how to chain tools together, and how to interpret results. They activate automatically based on what you ask.
...
See the [Skills page](/developer/mcp-server/skills/) for the full catalog and installation options.
...
See [Capabilities](/developer/mcp-server/capabilities/) for the full list of tools and example questions.
