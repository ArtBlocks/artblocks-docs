---
order: 700
description: PostParams — on-chain configurable parameters that let artworks evolve after minting.
---
...
Some projects that have used PostParams to enhance collector experience and artistic expression include:
...
Have an idea? Reach out to the Art Blocks team with questions!
...
This results in color swatch styling on the Art Blocks website:

![Color swatch example](/static/colorswatch.png)
